...
const Testimonials = () => {
    return (
        <section className="bg-gradient-to-b from-green-50 via-white to-green-100 dark:bg-gray-900 overflow-hidden py-16">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                ...
                >
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-green-800 dark:text-white drop-shadow-lg">
                        Farmer Reviews
                    </h2>
                ...
                <div className="grid mb-8 lg:mb-12 lg:grid-cols-2 gap-8">
                    {testimonials.map((testimonial, index) => (
                        <motion.figure 
                            ...
                            className="relative flex flex-col justify-center items-center p-8 text-center bg-white border-b border-green-200 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300"
                        >
                            {/* Accent bar */}
                            <span className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-green-400 via-lime-300 to-green-500 rounded-t-2xl"></span>
                            <blockquote className="mx-auto mb-8 max-w-2xl text-gray-600 dark:text-gray-400">
                                <motion.h3 
                                    initial={{ opacity: 0 }}
                                    whileInView={{ opacity: 1 }}
                                    transition={{ delay: 0.3 }}
                                    className="text-lg font-semibold text-green-800 dark:text-white"
                                >
                                    {testimonial.title}
                                </motion.h3>
                            ...
                            >
                                <motion.img 
                                    ...
                                    className="w-16 h-16 rounded-full ring-4 ring-green-200 dark:ring-green-700 shadow-lg border-2 border-white"
                                    src={testimonial.image}
                                    alt="profile picture"
                                />
                                <div className="space-y-0.5 font-medium dark:text-white text-left">
                                    <div className="text-lg font-bold text-green-700">{testimonial.name}</div>
