                ...
                <div className="grid mb-8 lg:mb-12 lg:grid-cols-2 gap-8">
                    {testimonials.map((testimonial, index) => (
                        <motion.figure 
                            ...
                            className="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300"
                        >
                            ...
                            >
                                <motion.img 
                                    ...
                                    className="w-12 h-12 rounded-full ring-4 ring-gray-200 dark:ring-gray-700"
